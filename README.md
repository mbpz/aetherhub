...
详见 [ROADMAP-DESIGN.md](ROADMAP-DESIGN.md)，核心三阶段：

| 阶段 | 时间 | 目标 |
|------|------|------|
| **Phase 1** | 2026 Q2 | 基础增强：Wasm真实执行、Codex真实调用、Tree-sitter集成 |
| **Phase 2** | 2026 Q3 | 执行增强：混合语义搜索、Claude Code插件、A2A协议、使用分析 |
| **Phase 3** | 2026 Q4 | 规模扩展：性能优化、企业功能、社区增长 |
